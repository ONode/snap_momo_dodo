...
Call.add({
    ...
    calltime: {type: Types.Datetime, default: Date.now, noedit: true, label: "Calling time"},
    dealstatus: {
    ...
    dealstatus_time: {type: Types.Datetime, default: Date.now, noedit: true, label: "Status update time"}
}, 'Call Data', {
